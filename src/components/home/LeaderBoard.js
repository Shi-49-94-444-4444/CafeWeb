      ...
      <div className={leaderBoard}>
        <div className={leaderBoard_left}>
          <Typography
            ...
            component="h1"
          >
            Order Your Favourite <br /> Cafe Easily
          </Typography>
          <Typography className={leaderBoard_left_p} component="p">
            We deliver 100% organic and fresh cafe. You can <br /> order right
            now!
          </Typography>
          <Button
            disableElevation
          ...
          <div className={quickTip_container}>
            <QuickTip
              Icon={<LocalMallIcon />}
              quicktip_details1="select your favourite cafe"
            ...
            <QuickTip
              ...
              quicktip_details1="Get your cafe within"
